...
public class alcool_13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alcool13);
    ...
    private void iniciarContador() {
        Handler handler = new Handler();
       Intent intent = new Intent(alcool_13.this, acido_sulfonico_14.class);
        TextView cont = findViewById(R.id.textView4);
