...
public class acido_sulfonico_14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acido_sulfonico14);
    ...
    private void iniciarContador() {
        Handler handler = new Handler();
        Intent intent = new Intent(acido_sulfonico_14.this, acido_carboxilico_15.class);
        TextView cont = findViewById(R.id.textView4);
