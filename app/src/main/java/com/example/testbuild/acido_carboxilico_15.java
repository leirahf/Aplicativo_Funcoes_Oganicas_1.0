...
public class acido_carboxilico_15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acido_carboxilico15);
    ...
    private void iniciarContador() {
        Handler handler = new Handler();
         Intent intent = new Intent(acido_carboxilico_15.this, finalscreen.class);
        TextView cont = findViewById(R.id.textView4);
