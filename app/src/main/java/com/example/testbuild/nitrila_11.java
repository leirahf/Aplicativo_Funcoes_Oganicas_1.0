...
public class nitrila_11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nitrila11);
    ...
    private void iniciarContador() {
        Handler handler = new Handler();
        Intent intent = new Intent(nitrila_11.this, haleto_de_acido_12.class);
        TextView cont = findViewById(R.id.textView4);
