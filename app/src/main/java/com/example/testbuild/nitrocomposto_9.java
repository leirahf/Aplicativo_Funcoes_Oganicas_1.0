...
public class nitrocomposto_9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nitrocomposto9);



        Handler handler = new Handler();
        //Intent intent = new Intent(nitrocomposto_9.this, Cetona_2.class);
        ...
        ImageView tioalcool = findViewById(R.id.imageView15);
        ImageView erro = findViewById(R.id.imageView14);
        ImageView erro2 = findViewById(R.id.imageView13);
        ...
        tioalcool.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        erro2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void iniciarContador() {
        Handler handler = new Handler();
        Intent intent = new Intent(nitrocomposto_9.this, ester_10.class);
        TextView cont = findViewById(R.id.textView4);
