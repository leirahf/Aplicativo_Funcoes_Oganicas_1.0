...
public class Haleto_Organico_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_haleto_organico3);
    ...
    private void iniciarContador() {
        Handler handler = new Handler();
       Intent intent = new Intent(Haleto_Organico_3.this, eter_4.class);
        TextView cont = findViewById(R.id.textView4);
