...
public class Tioalcool extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tioalcool);
        ...
        //zerar o arquivo
        int zerar = 0;
        editor.putInt("chave_numero", zerar);
        editor.apply();
    ...
    private void iniciarContador() {
        ...
        Intent intent = new Intent(Tioalcool.this, Cetona_2.class);
        TextView cont = findViewById(R.id.textView4);
