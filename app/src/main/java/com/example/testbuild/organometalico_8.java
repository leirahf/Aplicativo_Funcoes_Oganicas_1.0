...
public class organometalico_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_organometalico8);
    ...
    private void iniciarContador() {
        Handler handler = new Handler();
        Intent intent = new Intent(organometalico_8.this, nitrocomposto_9.class);
        TextView cont = findViewById(R.id.textView4);
